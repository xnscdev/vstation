/* app.vala -- This file is part of VStation.
...
public class VS.Application : Gtk.Application {
	public Application () {
		Object (application_id: "org.xnsc.vstation");
		activate.connect (() => new VS.Window (this).present ());
	}
}